...
AddSubClass("druid", "old ways", {
	...
	features : {
		...
		"subclassfeature3.1" : {
			...
			savetxt : { text : ["Adv vs Str and Con saves in Wood Wose"], },
			toNotesPage : [{
				name : "Wood Wose",
				note : [
		...
		"subclassfeature10" : {
			...
			source : [["LA:CM:PR", 25]],
			minlevel : 10,
			action : [["action", "Primeval Wrath (With Attack)"]],
			toNotesPage : [{
				name : "Deepwood Elder",
				note : [
		...
		"subclassfeature14" : {
			...
			source : [["LA:CM:PR", 25]],
			minlevel : 14,
			dmgres : [["Bludgeoning", "Bludgeon. (in wood wose)"], ["Piercing", "Piercing (in wood wose)"]],
