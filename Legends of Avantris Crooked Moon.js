...
SourceList["LA:CM"] = {
    name: "Legends of Avantris : Crooked Moon",
    abbreviation: "LA:CM",
...
RaceList.ashborn = {
    ...
    features: {
        "ashen legacy 1": {
            name: "Minor Illusion (Ashen Legacy)",
            source: [
                ["LA:CM", 53]
            ],
            minlevel: 1,
            spellcastingBonus: [{
                name: "Ashborn level 1",
        ...
        "ashen legacy 3": {
            name: "Charm Person (Ashen Legacy)",
            source: [
                ["LA:CM", 53]
            ],
            minlevel: 3,
        ...
        "ashen legacy 5": {
            name: "Invisibility (Ashen Legacy)",
            source: [
                ["LA:CM", 53]
            ],
            minlevel: 5,
    ...
    trait: "**Ashborn** (Creature type Fiend)" +
        ...
        "\n##\u25C6 Ashen Lineage##. I know Minor Illusion,  Charm Person at level 3, and Invisibility at level 5; These spells are always Prepared & you can cast them without a spell slot once each per Long Rest or use Spell Slots; Int, Wis, or Cha is your spellcasting ability. (Choose the ability with the lineage)"
};
RaceList.azureborn = {
    ...
    action: [
        ["bonus action", "Winds of Magic (Dash)"]
    ],
    extraLimitedFeatures: [{
        name: "Winds of Magic",
        usages: "Proficiency bonus per ",
    ...
    features: {
        "azure legacy 1": {
            name: "Guidance (Azure Legacy)",
            source: [
                ["LA:CM", 54]
            ],
            minlevel: 1,
            spellcastingBonus: [{
                name: "Azureborn level 1",
                spells: ["guidance"],
                selection: ["guidance"],
                firstCol: "atwill",
            }],
    ...
    trait: "**Azureborn** (Creature type Humanoid)" +
        "\n##\u25C6 Winds of Magic##. As a Bns A, I can take the Dash action and increase my Fly Speed by 10 feet until the end of the turn. I can use this trait a number of times equal to my Proficiency Bonus, and I regain all expended uses when I finish a Long Rest." +
        "\n##\u25C6 Glimpse Fate##. Once per Short/Long rest, when I roll Initiative, but am not surprised, I can choose a number of creatures equal to my Prof Bonus. The targets have Advantage on the Initiative rolls." +
        "\n##\u25C6 Azure Lineage##. I know Guidance, and Augury at level 3; These spells are always Prepared & I can cast them without a spell slot once each per Long Rest or use Spell Slots; Int, Wis, or Cha is my spellcasting ability. (Choose the ability with the lineage)"
};
RaceList.bogborn = {
    ...
    action: [
        ["bonus action", "Guiding Bond"],
        ["bonus action", "Regeneration"]
    ],
    extraLimitedFeatures: [{
        name: "Guiding Bond",
        usages: "Proficiency bonus per ",
    ...
    carryingCapacity: 2,
    trait: "**Bogborn** (Creature type Giant)" +
...
RaceList.curseborn = {
    ...
    trait: "**Curseborn** (Creature type Humanoid)" +
...
RaceList.deepborn = {
    ...
    action: [
        ["action", "Eldritch Gibbering"],
        ["bonus action", "Endless Hunger"]
    ],
    extraLimitedFeatures: [{
        name: "Endless Hunger",
        usages: 1,
    ...
    trait: "**Deepborn** (Creature type Aberration)" +
...
RaceList.gnarlborn = {
    ...
    size: 3,
    savetxt: {
        text: ["Adv. vs checks and saves against being moved against will or Grapled and Prone conditions; "],
    },
    speed: {
        walk: {
            spd: 30,
    ...
    action: [
        ["bonus action", "Root Sense"],
        ["bonus action", "Grasping Branches"]
    ],
    extraLimitedFeatures: [{
    ...
    carryingCapacity: 2,
    trait: "Gnarlborn (Creature type Plant)" +
...
RaceList.graveborn = {
    ...
    trait: "**Graveborn** (Creature type Undead)" +
...
RaceList.harvestborn = {
    ...
    languageProfs: ["Common", 2],
    action: [
        ["bonus action", "Heal (Gift of the Green"]
    ],
    extraLimitedFeatures: [{
        name: "Culling",
        usages: "Proficiency bonus per ",
    ...
    features: {
        "jack-o-lantern 1": {
            name: "Dancing Lights (Jack-O-Lantern)",
            source: [
                ["LA:CM", 60]
            ],
            minlevel: 1,
            spellcastingBonus: [{
                name: "Harvestborn level 1",
    ...
    trait: "**Harvestborn** (Creature type Construct)" +
...
RaceList.plagueborn = {
    ...
    savetxt: {
        text: ["Adv. vs saves against Poisoned Condition and magical Contagions"],
    },
    languageProfs: ["Common", 2],
    ...
    trait: "Plagueborn (Creature type Humanoid)" +
...
RaceList.relicborn = {
    ...
    languageProfs: ["Common", 2],
    action: [
        ["bonus action", "Dance of Death"],
        ["reaction", "Moment of Remembrance"]
    ],
    extraLimitedFeatures: [{
    ...
    trait: "**Relicborn** (Creature type Undead)" +
...
RaceList.silkborn = {
    ...
    features: {
        "silken legacy 1": {
            name: "Thaumaturgy (Silken Legacy)",
            source: [
                ["LA:CM", 63]
            ],
            minlevel: 1,
            spellcastingBonus: [{
                name: "Silkborn level 1",
                spells: ["thaumaturgy"],
        ...
        "silken legacy 3": {
            name: "Find Familiar (Silken Legacy)",
            source: [
                ["LA:CM", 63]
            ],
            minlevel: 3,
    ...
    trait: "**Silkborn** (Creature type Humanoid)" +
...
RaceList.stoneborn = {
    ...
    languageProfs: ["Common", 2],
    action: [
        ["bonus action", "Argent Gleam (Bless or Dash)"],
        ["reaction", "Silver Bulwark"]
    ],
    extraLimitedFeatures: [{
        name: "Argent Gleam",
        usages: 1,
    ...
    trait: "**Stoneborn** (Creature type Construct)" +
...
RaceList.threadborn = {
    ...
    features: {
        "soothing heart 1": {
            name: "Guidance (Soothing Heart)",
            source: [
                ["LA:CM", 65]
            ],
            minlevel: 1,
            spellcastingBonus: [{
                name: "Threadborn level 1",
                spells: ["guidance"],
                selection: ["guidance"],
                firstCol: "atwill",
            }],
        ...
        "soothing heart 5": {
            name: "Calm Emotions (Soothing Heart)",
            source: [
                ["LA:CM", 6]
            ],
            minlevel: 5,
    ...
    trait: "**Threadborn** (Creature type Construct)" +
...
AddSubClass("barbarian", "experiment", {
    ...
    features: {
        ...
        "subclassfeature3.1": {
            ...
            minlevel: 3,
            action: [
                ["bonus action", "Change Serum (While Raging)"]
            ],
            toNotesPage: [{
        ...
        "subclassfeature10": {
            ...
            minlevel: 10,
            savetxt: {
                text: ["End Blinded, Deafened, Poisoned or Stunned when Entering Rage; Adv. vs Con saves (While Raging); "],
            },
...
AddSubClass("cleric", "harvest", {
    ...
    features: {
        ...
        "subclassfeature6": {
            ...
            minlevel: 6,
            action: [
                ["reaction", "Blessing of the Seasons"]
            ],
...
AddSubClass("druid", "old ways", {
    ...
    features: {
        ...
        "subclassfeature3.1": {
            ...
            savetxt: {
                text: ["Adv vs Str and Con saves in Wood Wose"],
            },
            toNotesPage: [{
                name: "Wood Wose",
                note: [
        ...
        "subclassfeature6": {
            ...
            calcChanges: {
                atkAdd: [
                    function(fields, v) {
                        if (v.isMeleeWeapon) {
                            fields.Description += (fields.Description ? '; ' : '') + "Once per turn +1d6 Piercing damage";
                        }
                    },
                    "Once on each of my turns when I hit a creature with a melee attack roll using a weapon, the target takes an extra 1d6 Piercing damage."
                ],
            },
            toNotesPage: [{
                name: "Oak and Thorn",
        ...
        "subclassfeature10": {
            ...
            minlevel: 10,
            action: [
                ["action", "Primeval Wrath (With Attack)"]
            ],
            toNotesPage: [{
                name: "Deepwood Elder",
                note: [
        ...
        "subclassfeature14": {
            ...
            minlevel: 14,
            dmgres: [
                ["Bludgeoning", "Bludgeon. (in wood wose)"],
                ["Piercing", "Piercing (in wood wose)"]
            ],
            action: [
                ["reaction", " (Vengeance of the Elders)"]
            ],
            toNotesPage: [{
                name: "Ancient Protector",
                note: [
...
AddSubClass("monk", "pestilent haze", {
    ...
    features: {
        "subclassfeature3": {
            ...
            minlevel: 3,
            action: [
                ["action", "Miasmic Plague (with Attack Action; 1 FP)"]
            ],
            description: desc([
        ...
        "subclassfeature3.1": {
            ...
            recovery: "long rest",
            savetxt: {
                text: ["Adv. vs saves against Poisoned condition or magical contagions"],
            },
        ...
        "subclassfeature11": {
            ...
            minlevel: 11,
            action: [
                ["bonus action", "Scurrying Spread (1 FP)"]
            ],
            description: desc([
    ...
    features: {
        ...
        "subclassfeature7": {
            ...
            addMod: [{
                    ...
                    field: "Investigation",
                    mod: "Cha",
                    text: "I can add my Charisma modifier to Investigation rolls."
                },
                {
                    type: "skill",
                    field: "Insight",
                    mod: "Cha",
                    text: "I can add my Charisma modifier to Insight rolls."
                },
            ],
...
AddSubClass("ranger", "grim harbinger", {
    ...
    features: {
        "subclassfeature3": {
            ...
            minlevel: 3,
            action: [
                ["bonus action", " (Mark Target)"],
                ["bonus action", " (Command Grim)"]
            ],
            usages: "Wisdom modifier per ",
            usagescalc: "event.value = Math.max(1, What('Wis Mod'));",
            recovery: "short rest",
        ...
        "subclassfeature11": {
            ...
            minlevel: 11,
            action: [
                ["reaction", "Inescapable Fate (Force Reroll)"]
            ],
            dmgres: ["Necrotic"],
            usages: 1,
            recovery: "long rest",
...
CreatureList.grim = {
    ...
    addMod: [{
            ...
            field: "all",
            mod: "Prof",
            text: "The Grim adds it proficiency bonus to all its ability check and saving throws."
        },
        {
            type: "skill",
            field: "Init",
...
AddSubClass("rogue", "sinner", {
    ...
    features: {
        ...
        "subclassfeature3.1": {
            ...
            minlevel: 3,
            weaponProfs: [false, false, ["pistol"]],
            toolProfs: [
                ["Gaming Sets", 2]
            ],
            spellcastingBonus: [{
        ...
        "subclassfeature6": {
            ...
            toNotesPage: [{
                ...
                note: [
                    ...
                    "I can pass through small holes, narrow openings, and even mere cracks.",
...
AddSubClass("warlock", "horned king", {
    ...
    features: {
        ...
        "subclassfeature3.1": {
            ...
            action: [
                ["action", ""],
                ["reaction", " (When attacked by crea)"]
            ],
            description: desc([
...
AddSubClass("wizard", "occultist", {
    ...
    features: {
        ...
        "subclassfeature10": {
            ...
            minlevel: 10,
            action: [
                ["bonus action", " (Cause Intrusion and Change)"]
            ],
            description: desc([
            ...
            "alien consciousness": {
                name: "Occult Presence: Alien Consciousness",
                savetxt: {
                    immune: ["Charmed", "Frightened", "Possessed"],
                },
                description: desc([
                    "When I cause an Intrusion, I can roll twice and choose the result to use, and I can negate an Intrusion by gaining 1 level of Exhaustion. Additionally, I gain Immunity to the Charmed and Frightened conditions, and I can't be Possessed. I can change my benefit when I finish a Long Rest or As a Bonus Action, I can cause an automatic Intrusion (and increase the die's size one step, up to its starting size) to change my chosen benfit.",
                ]),
            },
            "cosmic resistance": {
                name: "Occult Presence: Cosmic Resistance",
                dmgres: ["Necrotic", "Psychic"],
                description: desc([
                    "When I cause an Intrusion, I can roll twice and choose the result to use, and I can negate an Intrusion by gaining 1 level of Exhaustion. Additionally, I gain Resistance to Necrotic and Psychic damage. I can change my benefit when I finish a Long Rest or As a Bonus Action, I can cause an automatic Intrusion (and increase the die's size one step, up to its starting size) to change my chosen benfit.",
                ]),
            },
            "spacial domination": {
                name: "Occult Presence: Spacial Domination",
                speed: {
                    fly: {
                        spd: "walk",
                        enc: "walk"
                ...
                description: desc([
                    "When I cause an Intrusion, I can roll twice and choose the result to use, and I can negate an Intrusion by gaining 1 level of Exhaustion. Additionally, I gain a Fly Speed equal to my Speed and can hover. I can change my benefit when I finish a Long Rest or As a Bonus Action, I can cause an automatic Intrusion (and increase the die's size one step, up to its starting size) to change my chosen benfit.",
                ]),
            },
        },
        "subclassfeature14": {
...
AddSubClass("wizard", "philosopher", {
    ...
    features: {
        ...
        "subclassfeature3.1": {
            ...
            toNotesPage: [{
                ...
                note: [
                    ...
                    "Vitriolic Enhancement. When I cast a spell that deals damage, I can expend 1 Quintessence as an additional Material component to change one damage type the spell deals to Force.",
                ],
            }],
        },
        "subclassfeature6": {
        ...
        "subclassfeature14": {
            ...
            minlevel: 14,
            action: [
                ["reaction", "Equivalent Exchange (5 Q)"]
            ],
            description: desc([
...
BackgroundFeatureList["memory starved"] = {
    description: desc([
        "",
    ]),
    source: [
...
BackgroundList["crimson aspirant"] = {
    ...
    feature: "Crimson Ritualist",
    trait: [
        "",
    ],
};
BackgroundFeatureList["crimson ritualist"] = {
    description: desc([
        "",
    ]),
    source: [
...
BackgroundList["crossroads gambler"] = {
    ...
    feature: "Fate Gambler",
    trait: [
        "",
    ],
};
BackgroundFeatureList["fate gambler"] = {
    description: desc([
        "",
    ]),
    source: [
...
BackgroundFeatureList["cult initiate"] = {
    description: desc([
        "",
    ]),
    source: [
...
BackgroundList["ghostlight passenger"] = {
    ...
    feature: "Ghostlight Medium",
    trait: [
        "",
    ],
};
BackgroundFeatureList["ghostlight medium"] = {
    description: desc([
        "",
    ]),
    source: [
...
BackgroundList["night stalker"] = {
    ...
    feature: "Hunter of Hunters",
    trait: [
        "",
    ],
};
BackgroundFeatureList["hunter of hunters"] = {
    description: desc([
        "",
    ]),
    source: [
...
BackgroundFeatureList["unreflected"] = {
    description: desc([
        "",
    ]),
    source: [
...
BackgroundList["rest warden"] = {
    ...
    feature: "Grave Keeper",
    trait: [
        "",
    ],
};
BackgroundFeatureList["grave keeper"] = {
    description: desc([
        "",
    ]),
    source: [
...
BackgroundList.reveler = {
    ...
    feature: "Reveling Fool",
    trait: [
        "",
    ],
};
BackgroundFeatureList["reveling fool"] = {
    description: desc([
        "",
    ]),
    source: [
...
BackgroundList["scholar of the forbidden"] = {
    ...
    feature: "Dread Speech",
    trait: [
        "",
    ],
};
BackgroundFeatureList["dread speech"] = {
    description: desc([
        "",
    ]),
    source: [
...
BackgroundList["wicker weaver"] = {
    ...
    feature: "Charm Twister",
    trait: [
        "",
    ],
};
BackgroundFeatureList["charm twister"] = {
    description: desc([
        "",
    ]),
    source: [
...
FeatsList.altered = {
    ...
    "natural armor (dex)": {
        ...
        armorOptions: [{
            regExpSearch: /^(?=.*natural)(?=.*armor)(?=.*dex).*$/i,
            name: "Natural Armor (Dex)",
            source: [
                ["LA:CM", 113]
            ],
    ...
    "natural armor (con)": {
        ...
        armorOptions: [{
            regExpSearch: /^(?=.*natural)(?=.*armor)(?=.*con).*$/i,
            name: "Natural Armor (Con)",
            source: [
                ["LA:CM", 113]
            ],
    ...
    description: "Pick Aquatic Adaptation, Natural Armor (Dex), Natural Armor (Con), Natural Weapons, or Night Vision.",
    descriptionFull: [
...
FeatsList["crimson ritualist"] = {
    ...
    action: [
        ["bonus action", "Bottled Life (Drink)"]
    ],
    spellcastingAbility: [4, 5, 6],
    spellcastingBonus: [{
        name: "Blood Lash",
...
FeatsList["cult initiate"] = {
    ...
    spellcastingAbility: [4, 5, 6],
    extraLimitedFeatures: [{
        name: "Cult Initiate (1st-level Warlock spell)",
        usages: 1,
        recovery: "short rest",
    }],
    spellFirstColTitle: "SR",
    spellcastingBonus: [{
        name: "Cantrip",
        "class": "warlock",
        times: 2,
...
FeatsList["memory starved"] = {
    ...
    savetxt: {
        adv_vs: ["Charmed", "Having memories read or altered"],
    },
...
FeatsList["dark bargains"] = {
    ...
    "bestial awakening": {
        ...
        descriptionFull: desc([
            ...
            "***Searing Silver***. Damage from Silvered Weapons ignores any Resistance or Immunity to damage you have. If you take damage from a Silvered Weapon or touch silver with your bare skin (or its equivalent), you can't regain Hit Points until you finish a Short or Long Rest.",
        ]),
    },
    "call of the lonely": {
        name: "Call of the Lonely",
        action: [
            ["bonus action", "Summon Doppelganger"],
            ["action", "Dismiss Doppelganger"]
        ],
        ExtraLimitedFeatures: [{
            name: "Summon Doppleganger",
            usages: 1,
            recovery: "long rest",
        }],
    ...
    "might of the old": {
        ...
        action: [
            ["bonus action", "Primeval Strength"]
        ],
        ExtraLimitedFeatures: [{
            name: "Primeval Strength",
            usages: 1,
            recovery: "long rest",
        }],
    ...
    "self-serving sacrifice": {
        ...
        action: [
            ["reaction", "Critical Savior (Switch Places)"]
        ],
        ExtraLimitedFeatures: [{
            name: "Critical Savior",
            usages: 1,
            recovery: "short rest",
        }],
        spellcastingAbility: [4, 5, 6],
    ...
    "shrouded spirit": {
        ...
        dmgres: ["Necrotic"],
        savetxt: {
            adv_vs: ["spells and effects created by Undead"],
        },
    ...
    "wings of whispers": {
        ...
        action: [
            ["bonus action", "Murderous Flight"]
        ],
        ExtraLimitedFeatures: [{
            name: "Murderous Flight",
            usages: 1,
            recovery: "short rest",
        }],
...
//Familiars
CompanionList["crooked moon familiar"] = {
    name: "Crooked Moon Familiar",
    nameTooltip: "Crooked Moon Familiar Ritual",
    nameMenu: "Crooked Moon Familiar (Special Secret Ritual)",
    source: [
        ["LA:CM", 580]
    ],
    action: [
    ...
    notes: [{
        name: "Familiar Bond.",
        description: [
            "When I perform a 10-minute ritual using materials worth 100+ GP (noted in each familiar's statblock), the familiar can form a magical bond with me and serve as my familiar. This bond ends when I die, or when the familiar decides to end it (no action required). While the bond lasts, the familiar and I gain the following benefits.",
        ].join("\n   "),
        joinString: ", "
    }, {
        name: "Bonded Sympathy.",
        description: [
            "The familiar can choose to exclude me from any area of effect it creates, such as a damaging Sphere or an Emanation. Additionally, if the familiar has another feature that creates a bond, that bond forms as part of the familiar bond."
        ].join("\n   "),
        joinString: ", "
    }, {
        name: "Channel Magic.",
        description: [
            "When I cast a spell with a range of touch while within 100 feet of the familiar, the familiar can take a Reaction to deliver the touch when the spell is cast.",
        ].join("\n   "),
        joinString: ", "
    }, {
        name: "Telepathic Connection.",
        description: [
            "While the familiar and I are within 100 feet of each other, we can communicate telepthically. Additionally, as a Bonus Action, I can see and hear through the familiar's senses until the start of my next turn, gaining the benefit of any special senses the familiar has.",
        ].join("\n   "),
        joinString: ", "
    }, {
        name: "Revival.",
        description: [
            "If the familiar dies while the bond exists, I can restore the familiar to life with all its Hit Points by performing a 1-hour version of the Familiar Bond ritual.",
        ].join("\n   "),
        joinString: "",
    }],
};
CreatureList["corn dolly"] = {
    name: "Corn Dolly",
    regExpSearch: /corn dolly/i,
    source: [
        ["LA:CM", 581]
    ],
    size: 5,
    type: "Construct",
    alignment: "Neutral",
    companion: "crooked moon familiar",
    ac: 10,
    hp: 38,
    hd: [11, 4],
    speed: "20 ft",
    scores: [3, 10, 12, 12, 8, 16],
    saves: ["", "", "", "", "", ""],
    skills: {
        "perception": 1,
    },
    ...
    traits: [{
        ...
        description: "To Bond with this Familiar you must do a 10-minute ritual and use 100+ GP of materials which must include a (Curved blade plated in gold).",
        joinString: "\n   ",
    }, {
        name: "Husk Body",
        description: "The corn dolly can move through a space as narrow as 1 inch without expending extra movement to do so.",
        joinString: "\n   ",
    }, {
        name: "Uneasy Visage",
        description: "The strange, childlike inked face unnerves onlookers. While a creature is holding the corn dolly creatures within 10 feet of it have Disadvantage on Wisdom (Insight) checks made against the creature.",
        joinString: "\n   ",
    }],
    attacks: [{
        name: "Husk Cut",
        ...
        range: "30 ft",
        dc: true,
        description: "One Crea, the corn dolly can see, Wis save, Fail: Dmg, Success: Half Dmg",
    }, {
        name: "Sowing Dread (2/Day)",
        ability: 6,
        damage: ["", "", "Frightened"],
        range: "15 ft Cone",
        dc: true,
        description: "Wis save, Fail: Frightened until end of crea. next turn.",
    }],
    actions: [{
        name: "Reaction : Silent Protector",
        description: "Once per Short or Long rest when a creature within 60 ft fails a save against an effect that doesn't deal damage, the corn dolly suffers the effect of the failure instead of the creature.",
    }],
    header: "Crooked Moon Familiar",
};
CreatureList["crooked hare"] = {
    name: "Crooked Hare",
    regExpSearch: /crooked hare/i,
    source: [
        ["LA:CM", 582]
    ],
    size: 5,
    ...
    traits: [{
        name: "Material Requirement",
        description: "To Bond with this Familiar you must do a 10-minute ritual and use 100+ GP of materials which must include (Anything stolen or gained by trickery).",
        joinString: "\n   ",
    }, {
        name: "Trackless Step",
        description: "The crooked hare leaves no tracks, or it leaves the tracks of a Large or smaller creature of its choice. If it doesn't have the Incapacitated condition, it can share the effect of this trait with another creature within 5 feet (no action required).",
        joinString: "\n   ",
    }, {
        name: "Twisting Bite Curse",
        description: "The cursed creature's limbs sporadically twist and move in unnatural ways, giving the creature Disadvantage on attack rolls and on ability checks that rely on Charisma.",
        joinString: "\n   ",
    }],
    attacks: [{
        name: "Twisting Bite",
        ...
        damage: [1, 4, "Piercing"],
        range: "Melee (5 ft)",
        description: "plus 7 (2d6) Poison dmg, and if target is a crea must succeed DC 11 Cha save or be cursed for 24 hours (see Traits)",
    }],
    header: "Crooked Moon Familiar",
};
CreatureList["devil's glove"] = {
    name: "Devil's Glove",
    regExpSearch: /devil's glove/i,
    source: [
        ["LA:CM", 583]
    ],
    size: 5,
    ...
    scores: [14, 10, 15, 3, 8, 4],
    saves: ["", "", "", "", "", ""],
    condition_immunities: "Deafened, Frightened, Poisoned",
    ...
    traits: [{
        name: "Material Requirement",
        description: "To Bond with this Familiar you must do a 10-minute ritual and use 100+ GP of materials which must include (Rare wood chips).",
        joinString: "\n   ",
    }, {
        name: "Scent of Death",
        description: "Creatures that can smell have Advantage on Wisdom (Perception) checks made to find the devil's glove.",
        joinString: "\n   ",
    }, {
        name: "Spider Climb",
        description: "The devil's glove can climb difficult surfaces, including along ceilings, without needing to make an ability check.",
        joinString: "\n   ",
    }, {
        name: "Tendril Attachment",
        description: "While attached, the devil's glove can't make Tendril attacks against other targets, and if the target is a creature, the targe has the Poisoned condition until the start of its next turn if it can smell the devil's glove. The devil's glove can detach itself by spending 5 ft of its movment. The target or a creature within 5 feet of it can detach the devil's glove as an action.",
        joinString: "\n   ",
    }],
    attacks: [{
        name: "Tendril",
        ...
        range: "Melee (5 ft)",
        description: "plus 7 (2d6) Necrotic dmg, and the devil's glove attaches to the target (See Traits).",
    }, {
        name: "Decaying Bloom (2/Day)",
        ability: 3,
        damage: [2, 8, "Necrotic"],
        range: "10 ft Emanation",
        dc: true,
        description: "Con save, Fail: dmg + can't regain HP until start of devil's glove's next turn. Success: half dmg only.",
    }],
    actions: [{
        name: "Bonus Action : Symbiosis",
        description: "The devil's glove forms a magical bond with a willing creature it touches. The bonded creature doesn't need to eat or drink, and the creature has Adv on saves to avoid or end the Poisoned condition. The bond ends when the creature dies, the devil's glove dies, the devil's glove ends the bond (no action required), or when the devil's glove uses this Bonus Action again.",
    }],
    header: "Crooked Moon Familiar",
};
CreatureList.dingpot = {
    name: "Dingpot",
    regExpSearch: /dingpot/i,
    source: [
        ["LA:CM", 584]
    ],
    size: 5,
    ...
    hp: 22,
    hd: [4, 4],
    speed: "10 ft, fly(hover) 20 ft",
    scores: [6, 14, 16, 10, 12, 12],
    saves: ["", "", "", "", "", ""],
    skills: {
        "medicine": 3,
        "perception": 3,
    ...
    traits: [{
        name: "Material Requirement",
        description: "To Bond with this Familiar you must do a 10-minute ritual and use 100+ GP of materials which must include (Spices and rose quartz).",
        joinString: "\n   ",
    }, {
        name: "Boil and Bubble",
        description: "While the dingpot doesn't have the incapacitated condition, it can prvide enough heat to boil water within its vessel.",
        joinString: "\n   ",
    }],
    attacks: [{
        name: "Steam Spray",
        ...
        damage: [2, 4, "Fire"],
        range: "60 ft",
        description: "On a hit, the target has DisAdv on its next atk roll before start of dingpot next turn, Being underwater doesn't grant Reist to this Fire dmg.",
    }],
    actions: [{
        name: "Brew (1/Day)",
        description: "The dingpot produces a magical elixir within its vessel. The elixir remains potent for 24 hours. It can choose from the following brews:\n\u2022\Healing Draught. As a Bonus Action, a creature can drink the elixir to regain 4 (1d6+1) Hit Points.\n\u2022\Lucky Draught. As a Bonus Action, a creature can drink the elixir to gain startling luck for 10 minutes. When the creature fails an ability check or a saving throw, it can reroll the d20 and use the new roll. Once this causes a roll to succeed, the effect of the elixir ends early.",
        joinString: "\n   ",
    }],
    header: "Crooked Moon Familiar",
};
CreatureList["ghost crawler"] = {
    name: "Ghost Crawler",
    regExpSearch: /ghost crawler/i,
    source: [
        ["LA:CM", 585]
    ],
    size: 5,
    ...
    hd: [10, 4],
    speed: "30 ft, climb 30 ft",
    scores: [2, 16, 10, 1, 10, 2],
    saves: ["", "", "", "", "", ""],
    skills: {
        "stealth": 5,
    },
    senses: "Darkvision 30 ft, Seer's Strand",
    languages: "Understands Common but can't speak",
    challengeRating: 1,
    proficiencyBonus: 2,
    attacksAction: 2,
    traits: [{
        name: "Material Requirement",
        description: "To Bond with this Familiar you must do a 10-minute ritual and use 100+ GP of materials which must include (Silk threads soaked in wine).",
        joinString: "\n   ",
    }, {
        name: "Ephemeral Body",
        description: "The crawler can move through a space as narrow as 1 inch wthout expending extra movement to do so.",
        joinString: "\n   ",
    }, {
        name: "Seer's Strand",
        description: "The crawler can see and hear through the space of its Ether Webs as if it were in that space.",
        joinString: "\n   ",
    }, {
        name: "Spider Climb",
        description: "The crawler can climb difficult surfaces, including along ceilings, without needing to make an ability check.",
        joinString: "\n   ",
    }, {
        name: "Web Walker",
        description: "The crawler ignores movement restrictions caused by webs, and the crawler knows the location of any other creature in contact with the same web.",
        joinString: "\n   ",
    }],
    attacks: [{
        name: "Bite",
        ...
        damage: [1, 4, "Piercing"],
        range: "Melee (5 ft)",
        description: "On a hit, the target is Posoned until the start of the crawler's next turn.",
    }],
    actions: [{
        name: "Multiattack",
        description: "The crawler makes two Bite attacks.",
        joinString: "\n   ",
    }, {
        name: "Ether Webs (2/Day)",
        description: "The crawler fills a 5-foot Cube with Invisible, ephemeral webs for 8 hours. If the web isn't anchored between two solid masses, (such as walls or trees) or layered across a floor, wall or ceiling,the web collapses on itself and vanishes. When a creature touches the webbing, the crawler knows the location of the creature as long as they are on the same plane of existence.",
        joinString: "\n   ",
    }],
    header: "Crooked Moon Familiar",
};
CreatureList.goatstealer = {
    name: "Goatstealer",
    regExpSearch: /goatstealer/i,
    source: [
        ["LA:CM", 586]
    ],
    size: 4,
    ...
    traits: [{
        name: "Material Requirement",
        description: "To Bond with this Familiar you must do a 10-minute ritual and use 100+ GP of materials which must include (Incense and spoiled meat).",
        joinString: "\n   ",
    }, {
        name: "Pack Tactics",
        description: "The goatstealer has Advantage on an attack roll against a creature if at least one of the goatstealer's allies within 5 feet of the creature and the ally doesn't have the Incapacitated condition.",
        joinString: "\n   ",
    }, {
        name: "Stench",
        description: "Constitution Saving Throw: DC 12, any creature that starts its turn in a 5-foot Emanation originating from the goatstealer. Failure: The target has the Poisoned condition until the start of its next turn. Success: The target is immune to the stench of all goatstealers for 1 hour.",
        joinString: "\n   ",
    }],
    attacks: [{
        name: "Bite",
        ...
        damage: [1, 6, "Piercing"],
        range: "Melee (5 ft)",
        description: "Plus 3 (1d6) Poison dmg. If the target is Medium or smaller crea, it is Grappled (escape DC 12) Until Grapple ends, at start of goatstealer's turn takes 3 (1d6) Poison dmg.",
    }],
    header: "Crooked Moon Familiar",
};
CreatureList.hemonculus = {
    name: "Hemonculus",
    regExpSearch: /hemonculus/i,
    source: [
        ["LA:CM", 587]
    ],
    size: 5,
    ...
    traits: [{
        name: "Material Requirement",
        description: "To Bond with this Familiar you must do a 10-minute ritual and use 100+ GP of materials which must include (Fresh blood and gem dust).",
        joinString: "\n   ",
    }, {
        name: "Blood Sense",
        description: "The hemonculus knows the location of any Bloodied creature within 60 feet of it, unless the creature is a Construct or Undead.",
        joinString: "\n   ",
    }, {
        name: "Flyby",
        description: "The hemonculus doesn't provide an Opportunity Attack when it flies out of an enemy's reach.",
        joinString: "\n   ",
    }, {
        name: "Magic Resistance",
        description: "The hemonculus has Advantage on saving throws against spells and other magical effects.",
        joinString: "\n   ",
    }, {
        name: "Claw Attachment",
        description: "While attached, the hemonculus automatically hits the target with its Claw attacks. The hemonculus can detach itself by spending 5 ft of its movment. The target or a creature within 5 feet of it can detach the hemonculus as an action.",
        joinString: "\n   ",
    }],
    attacks: [{
        name: "Claw",
        ...
        damage: [1, 4, "Slashing"],
        range: "Melee (5 ft)",
        description: "Plus 3 (1d6) Necrotic dmg, and the hemonculus attaches to the target (See Traits)",
    }],
    actions: [{
        name: "Exsanguinate (1/Day)",
        description: "The hemonculus magically draws blood from nearby creatures. Constitution Saving Throw: DC 13, each creature of the hemonculus' choice in a 15-foot Emanation originating from the hemonculus. Failure: 10 (3d6) Necrotic damage, and the target can't regain Hit Points until the start of the hemonculus' next turn. Success: Half damage only. Success or Failure: If the hemonculus is attached to a creature, the hemonculus regains Hit Points equal to the Necrotic damage taken by that target.",
        joinString: "\n   ",
    }],
    header: "Crooked Moon Familiar",
};
CreatureList["magpie of omens"] = {
    name: "Magpie of Omens",
    regExpSearch: /magpie of omens/i,
    source: [
        ["LA:CM", 588]
    ],
    size: 5,
    ...
    traits: [{
        name: "Material Requirement",
        description: "To Bond with this Familiar you must do a 10-minute ritual and use 100+ GP of materials which must include (Crystal or gemstone shards).",
        joinString: "\n   ",
    }, {
        name: "Flyby",
        description: "The magpie doesn't provoke an Opportunity Attack when if flies out of an enemy's reach.",
        joinString: "\n   ",
    }],
    attacks: [{
        name: "Beak",
    ...
    actions: [{
        name: "Multiattack",
        description: "The magpie makes two Beak attacks.",
        joinString: "\n   ",
    }, {
        name: "Bonus Action : Bonded Voice",
        description: "The magpie can form or dissolve a magical bond with a willing creature within 5 feet. While the bond lasts, the bonded creature can speak through the magpie using the creature's own voice and language, but with a birdlike lilt. The bond ends when the creature dies or if the magpie creates a new bond.",
        joinString: "\n   ",
    }, {
        name: "Reaction : One for Sorrow (1/Day)",
        description: "Once per day, when a creature within 30 feet of the magpie makes a D20 Test with Advantage the magpie can cause the target to roll 1d6 and subtract it from the total.",
        joinString: "\n   ",
    }, {
        name: "Reaction : Two for Joy (2/Day)",
        description: "Twice per day, when the magpie or another creature within 30 feet makes an ability check or a saving throw the magpie can cause the target to roll 1d4 and add it to the total.",
        joinString: "\n   ",
    }],
    header: "Crooked Moon Familiar",
};
CreatureList.moonshine = {
    name: "Moonshine",
    regExpSearch: /moonshine/i,
    source: [
        ["LA:CM", 589]
    ],
    size: 5,
    ...
    hp: 22,
    hd: [5, 4],
    speed: "5 ft, fly(hover) 30 ft",
    scores: [1, 16, 14, 11, 13, 9],
    saves: ["", "", "", "", "", ""],
    damage_resistances: "Acid, Bludgeoning, Cold, Fire, Lightning, Necrotic, Piercing, Slashing, Thunder",
    damage_immunities: "Poison",
    condition_immunities: "Exhaustion, Grappled, Paralyzed, Petrified, Poisoned, Prone, Restrained, Unconscious",
    senses: "Darkvision 60 ft, Detect Life",
    languages: "Common, plus one other language",
    challengeRating: 1,
    proficiencyBonus: 2,
    attacksAction: 2,
    traits: [{
        name: "Material Requirement",
        description: "To Bond with this Familiar you must do a 10-minute ritual and use 100+ GP of materials which must include (Broken glass and powdered onyx).",
        joinString: "\n   ",
    }, {
        name: "Detect Life",
        description: "The moonshine magically senses the direction of creatures up to 60 feet away that aren't Constructs or Undead.",
        joinString: "\n   ",
    }, {
        name: "Ephemeral",
        description: "The moonshine can't wear or carry anything.",
        joinString: "\n   ",
    }, {
        name: "Illumination",
        description: "The moonshine sheds Bright Light in a 15-foot radius and Dim Light for an additional 15 feet.",
        joinString: "\n   ",
    }, {
        name: "Incorporeal Movement",
        description: "The moonshine can move through other creatures and objects as if they were Difficult Terrain. It takes 5 (1d10) Force damage if it ends its turn inside an object.",
        joinString: "\n   ",
    }],
    attacks: [{
        name: "Gloomy Touch",
    ...
    actions: [{
        name: "Multiattack",
        description: "The moonshine makes two Gloomy Touch attacks.",
        joinString: "\n   ",
    }, {
        name: "Siphon Life (2/Day)",
        description: "As an Action, the Moonshine can cause one creature that isn't a Construct or Undead the moonshine can see within 5 feet to make a Con save DC 11. Fail: The target is stunned until the end of the moonshine's next turn, and the moonshine or a creature of its choice within 30 feet regain 3 (1d6) Hit Points.",
        joinString: "\n   ",
    }],
    header: "Crooked Moon Familiar",
};
CreatureList["nameless thing"] = {
    name: "Nameless Thing",
    regExpSearch: /nameless thing/i,
    source: [
        ["LA:CM", 590]
    ],
    size: 5,
    ...
    hp: 17,
    hd: [5, 4],
    speed: "10 ft, fly(hover) 40 ft",
    scores: [6, 14, 12, 16, 10, 9],
    saves: ["", "", "", "", "", ""],
    skills: {
        "arcana": 5,
        "perception": 2,
    ...
    senses: "Blindsight 30 ft, Telepathy 30 ft",
    ...
    traits: [{
        name: "Material Requirement",
        description: "To Bond with this Familiar you must do a 10-minute ritual and use 100+ GP of materials which must include (Meteorite fragments).",
        joinString: "\n   ",
    }, {
        name: "Flyby",
        description: "The nameless thing doesn't provoke an Opportunity Attack when it flies out of an enemy's reach.",
        joinString: "\n   ",
    }],
    attacks: [{
        name: "Psychic Strike",
        ...
        damage: [1, 12, "Psychic"],
        range: "Melee (5 ft)",
        description: "If target is a crea, it is Frightened until the start of the nameless thing's next turn.",
    }],
    actions: [{
        name: "Invisibility",
        description: "As an Action, the nameless thing casts Invisibility on itself, requiring no spell components and using Intelligence as the spellcasting ability. When it caststhe spell, the namelss thing can extend the effect of the spell to a creature it is touching. The spell ends early if either creature breaks the spell on itself or if the namelss thing stops touching the other creature. Once the namelss thing extends the spell in this way, it can't do so again until it finishes a Long Rest.",
        joinString: "\n   ",
    }],
    header: "Crooked Moon Familiar",
};
CreatureList.ravencraft = {
    name: "Ravencraft",
    regExpSearch: /ravencraft/i,
    source: [
        ["LA:CM", 591]
    ],
    size: 5,
    ...
    traits: [{
        name: "Material Requirement",
        description: "To Bond with this Familiar you must do a 10-minute ritual and use 100+ GP of materials which must include a (Silver wire).",
        joinString: "\n   ",
    }, {
        name: "Undead Fortitude",
        description: "If damage reduces the raencraft to 0 Hit Points, it makes a Constitution saving throw (DC 5 plus the damage taken) unless the damage is Radiant or from a Critical Hit. On a successful save, the ravencraft drops to 1 Hit Point instead.",
        joinString: "\n   ",
    }],
    attacks: [{
        name: "Beak",
    ...
    actions: [{
        name: "Harbinger of Doom (2/Day)",
        description: "As an Action, the ravencraft lets out a wail of anguish commingling with the croaking of ravens. one creature within 60 feet must make a Wis save DC 11. Fail: 5 (1d10) Psychic damage, and the target has the Frightened condition until the end of its next turn. Success: Half damage only.",
        joinString: "\n   ",
    }, {
        name: "Reaction : Death Veil",
        description: "When a creature within 30 feet of the ravencraft makes a Death Saving Throw, the ravencraft grants the creature Advantage on the save.",
        joinString: "\n   ",
    }],
    header: "Crooked Moon Familiar",
};
CreatureList["salmon of knowledge"] = {
    name: "Salmon of Knowledge",
    regExpSearch: /salmon of knowledge/i,
    source: [
        ["LA:CM", 592]
    ],
    size: 5,
    ...
    hp: 25,
    hd: [10, 4],
    speed: "5 ft, fly(hover; Orb of Water only) 30 ft, swim 30 ft",
    scores: [5, 16, 10, 14, 18, 10],
    saves: ["", "", "", "", "", ""],
    skills: {
        "arcana": 4,
        "history": 6,
    ...
    damage_resistances: "Fire (Orb of Water only), Psychic",
    condition_immunities: "Charmed, Frightened",
    senses: "Darkvision 60 ft, Telepathy 60 ft",
    languages: "Understands all but can' speak",
    challengeRating: 1,
    proficiencyBonus: 2,
    attacksAction: 2,
    traits: [{
        name: "Material Requirement",
        description: "To Bond with this Familiar you must do a 10-minute ritual and use 100+ GP of materials which must include a (Crushed opal).",
        joinString: "\n   ",
    }, {
        name: "Orb of Water",
        description: "The salmon is surrounded by a sphere of flowing water that moves with it. While inside of the sphere, the salmon has Resistance to Fire damage. A creature that grapples the salmon can choose to pull it out of the orb of water. The orb of water moves up to 20 feet toward the salmon at the start of each of the salmon's turns. If it enters the salmon's space, the Grappled condition ends on the salmon.",
        joinString: "\n   ",
    }, {
        name: "Water Breathing",
        description: "The salmon can breath only underwater.",
        joinString: "\n   ",
    }],
    attacks: [{
        name: "Water Spray",
    ...
    actions: [{
        name: "Multiattack",
        description: "The salmon makes two WaterSpray attacks. It can replace one attack with a use of Prophetic Guidance.",
        joinString: "\n   ",
    }, {
        name: "Prophetic Guidance (2/Day)",
        description: "As an Action, a creature the salmon can see within 30 ft gains a flash of foresight. Once in the next minute, when the creature fails a D20 Test, it can roll 1d4 and add it to the total, potentially turning the failure into a success.",
        joinString: "\n   ",
    }, {
        name: "Reaction : Echo from the Current",
        description: "When a creature within 5 feet of the salmon makes an Intelligence or Wisdom check, the salmon allows the creature to use the salmon's Wisdom modifier (+4) in place of its own ability modifier for the check.",
        joinString: "\n   ",
    }],
    header: "Crooked Moon Familiar",
};
CreatureList.witchwoven = {
    name: "Witchwoven",
    regExpSearch: /witchwoven/i,
    source: [
        ["LA:CM", 593]
    ],
    size: 5,
    ...
    damage_immunities: "Poison",
    condition_immunities: "Deafened, Exhaustion, Paralyzed, Petrified, Poisoned",
    senses: "Blindsight 60 ft",
    ...
    traits: [{
        name: "Material Requirement",
        description: "To Bond with this Familiar you must do a 10-minute ritual and use 100+ GP of materials which must include a (Ruby wrapped in a wicker cage).",
        joinString: "\n   ",
    }],
    attacks: [{
        name: "Cursed Scratch",
        ...
        damage: [1, 6, "Piercing"],
        range: "Melee (5 ft)",
        description: "Plus 3 (1d6) Necrotic damage, and the target has DisAdv on attack rolls until start of witchwoven's next turn.",
    }],
    actions: [{
        name: "Reaction : Protective Bond",
        description: "When a creature the witchwoven can see wihin 60 feet takes damage, the witchwoven can cause it to gain Resistance to the triggering damage, and the witchwoven takes 10 (3d6) Force damage.",
        joinString: "\n   ",
    }],
    header: "Crooked Moon Familiar",
};